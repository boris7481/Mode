...
#color_menu.add_command(label="grün" , command = change_bg_to_green)
#color_menu.add_command(label="rot" , command = change_bg_to_red)
#color_menu.add_command(label="blaue" , command = change_bg_to_blue)
...
menu_button = ttk.Menubutton(root,  text="Whäle Hintergrungfarbe")
menu_button.pack()

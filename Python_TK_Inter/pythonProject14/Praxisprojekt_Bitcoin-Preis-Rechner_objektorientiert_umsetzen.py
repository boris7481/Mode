...
import requests
# ce Programme ne s exceute pas ici alors qu il s execute dans le projet 2 ou il ya le code du Bitcoin
# le Module request existe dans ce programme 2 sans problem
